<?php
/* mods
	24Apr19 - zig - check post meta for show/hiding featured image 
*/
get_header();
						...
						<?php
							if ( ! post_password_required() ) :
								...
								if ( 'video' === $post_format && false !== ( $first_video = et_get_first_video() ) ) {
									...
									/* zig - check hide featured image custom post meta */
									$hide_thumb = get_post_meta(get_the_ID(), 'hide_featured_image', true);
								  if (!$hide_thumb) {
